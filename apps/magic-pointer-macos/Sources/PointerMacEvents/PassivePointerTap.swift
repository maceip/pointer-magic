...
private final class TapWorker: @unchecked Sendable {
    ...
    func start() async throws {
        try await withCheckedThrowingContinuation {
            ...
            thread.name = "MagicPointer.CGEventTap"
    ...
    private func handle(
        ...
        case .flagsChanged:
            ...
            guard keyCode == 61 else { break }
            let isDown = CGEventSource.keyState(.combinedSessionState, key: 61)
            let discrete = PointerDiscreteEvent(
                ...
                kind: isDown ? .rightOptionDown : .rightOptionUp,
                button: nil,
